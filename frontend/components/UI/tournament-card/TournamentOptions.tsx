...
import { Ellipsis, EllipsisVertical, Pen, Plus, Trash } from "lucide-react";
   ...
   return (
      <div className="relative">
         <Popover open={isOpen} onOpenChange={setIsOpen}>
            ...
            <PopoverContent
               align="end"
               className="bg-white rounded-lg shadow-popover border-0 w-40 p-0"
            >
               <Command>
                  <CommandList>
                     <CommandItem className="group w-full transition-colors hover:bg-alt-gray cursor-pointer p-0">
                        ...
                        >
                           ...
                           <Plus className="size-4 group-hover:text-black/80 transition-colors" />
                        </button>
                     </CommandItem>
                     <CommandItem className="group w-full transition-colors hover:bg-alt-gray cursor-pointer p-0">
                        <button
